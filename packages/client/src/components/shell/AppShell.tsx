...
export function AppShell({ search }: AppShellProps) {
  const { isReadonly, canAgent, mode, capabilities } = useCapabilities();
        ...
        <main className="workspace">
          <div className="workspace-header">
            ...
            <p className="workspace-subtitle">
              {canAgent
                ? "Agent capability available — runtime attach will land with protocol."
                : "Read-only shell — history browse without agent workers."}
            </p>
          </div>
